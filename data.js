...
const groupA = [
  ...
  { name: "winterfairs", tier: "diamond", status: "eliminated" },
  { name: "blzako", tier: "emerald", status: "eliminated" },
  { name: "PoloTheElephant", tier: "emerald", status: "eliminated" },
  { name: "BlueFalcon1423", tier: "emerald", status: "alive" },
  { name: "FrenchFryJ ", tier: "emerald", status: "eliminated" },
  { name: "imnotnyle", tier: "emerald", status: "alive" },
  { name: "ReaganMCSR", tier: "emerald", status: "eliminated" },
  { name: "Marinos353", tier: "emerald", status: "eliminated" },
  { name: "XerxthePhyrst", tier: "emerald", status: "eliminated" },
  { name: "andysh1sells", tier: "emerald", status: "alive" },
  { name: "thingys_", tier: "emerald", status: "eliminated" },
...
const groupB = [
  ...
  { name: "Envilatous", tier: "iron", status: "eliminated" },
